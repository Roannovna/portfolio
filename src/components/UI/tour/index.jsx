  ...
  const baseSteps = useMemo(() => [
    {
      ...
      description: (
        <>
          ...
          <br/>
          <br/>Сам тур основан на Ant Design Tour и полностью кастомизирован.
          <br/>
          <br/>Нажимайте {''} <img src={tourCastomIcons.arrowNext} /> чтобы продолжить и {''} <img src={tourCastomIcons.arrowPrev} /> чтобы вернуться назад.
          <br />Чтобы завершить тур в любой момент, нажмите на кнопку {''} <img src={tourCastomIcons.closeBtn} /> в правом верхнем углу.
        </>
      ),
      placement: 'center',
    ...
    },
    {
      ...
      description: (
        <>
          Статус бар в стиле Apple. Отображает текущее время и дату, уровень заряда батареи (при условии разрешения доступа к таким данным) и состояние подключения к интернету. 
          <br />
          <br />Графический индикатор уровня заряда батареи меняется в зависимости от текущего процента заряда.
        </>
      ),
